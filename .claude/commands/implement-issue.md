...
- You will be working mainly within a git worktree, use absolute paths rather than using cd.  E.g. use git's -C flag or absolute paths like "git -C /Users/tom/GitHub/issue-129 status"
...
- gh pr create: Must execute from within the worktree directory or use -C flag for git operations to maintain proper context

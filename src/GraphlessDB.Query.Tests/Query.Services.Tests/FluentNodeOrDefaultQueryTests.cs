...
namespace GraphlessDB.Query.Services.Tests
{
    [TestClass]
    public sealed class FluentNodeOrDefaultQueryTests
    {
        ...
        [TestMethod]
        public async Task GetAsyncWithUseConsistentReadReturnsNullWhenNotFound()
        {
            // Init
            var cancellationTokenSource = new CancellationTokenSource(TimeSpan.FromSeconds(5));
            var cancellationToken = Debugger.IsAttached ? CancellationToken.None : cancellationTokenSource.Token;
        ...
        [TestMethod]
        public async Task GetAsyncWithUseConsistentReadAndConnectionSizesReturnsNullWhenNotFound()
        {
            // Init
            var cancellationTokenSource = new CancellationTokenSource(TimeSpan.FromSeconds(5));
            var cancellationToken = Debugger.IsAttached ? CancellationToken.None : cancellationTokenSource.Token;
        ...
        [TestMethod]
        public async Task GetAsyncWithConfigureFuncReturnsNullWhenNotFound()
        {
            // Init
            var cancellationTokenSource = new CancellationTokenSource(TimeSpan.FromSeconds(5));
            var cancellationToken = Debugger.IsAttached ? CancellationToken.None : cancellationTokenSource.Token;
        ...
        [TestMethod]
        public async Task InToEdgesWhenNodeIsNullWorksCorrectly()
        {
            // Init
            var cancellationTokenSource = new CancellationTokenSource(TimeSpan.FromSeconds(5));
            var cancellationToken = Debugger.IsAttached ? CancellationToken.None : cancellationTokenSource.Token;
            ...
            // Query a non-existent node and attempt to traverse edges
            var edges = await services
                .CreateScope()
                .GraphDB()
                .Graph<TestGraph>()
        ...
        [TestMethod]
        public async Task OutToEdgesWhenNodeIsNullWorksCorrectly()
        {
            // Init
            var cancellationTokenSource = new CancellationTokenSource(TimeSpan.FromSeconds(5));
            var cancellationToken = Debugger.IsAttached ? CancellationToken.None : cancellationTokenSource.Token;

...
{
    [TestClass]
    public sealed class FileBasedAdvancedDatalogQueryTests : AdvancedDatalogQueryTests
    {
        ...
        {
            _testStoragePath = Path.Combine(Path.GetTempPath(), "GraphlessDB.Tests.AdvancedDatalog", Guid.NewGuid().ToString());

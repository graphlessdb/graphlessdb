...
{
    [TestClass]
    public sealed class FileBasedDatalogQueryTests : DatalogQueryTests
    {
        ...
        {
            _testStoragePath = Path.Combine(Path.GetTempPath(), "GraphlessDB.Tests.Datalog", Guid.NewGuid().ToString());

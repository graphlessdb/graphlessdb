...
{
    internal sealed class SortableDoubleString
    {
        ...
        public static double ToDouble(string value)
        {
            ...
            {
                '1' => double.Parse("-" + InvertString(value[2..]), CultureInfo.InvariantCulture),
                '2' => 0,
                _ => double.Parse(value[2..], CultureInfo.InvariantCulture)
            };
        }

        private static string EncodeSign(double value)
        {
        ...
        private static char EncodeOrderOfMagnitude(double value)
        {
            return Math.Sign(value) switch
            {
        ...
        private static string EncodeValue(double value)
        {
            return Math.Sign(value) switch
            {

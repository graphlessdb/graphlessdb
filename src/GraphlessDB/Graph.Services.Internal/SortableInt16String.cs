...
{
    internal sealed class SortableInt16String
    {
        ...
        public static short ToInt16(string value)
        {
            ...
            {
                '1' => short.Parse("-" + InvertString(value[2..]), CultureInfo.InvariantCulture),
                '2' => 0,
                _ => short.Parse(value[2..], CultureInfo.InvariantCulture)
            };
        }

        private static string EncodeSign(short value)
        {
        ...
        private static char EncodeOrderOfMagnitude(short value)
        {
            return Math.Sign(value) switch
            {
        ...
        private static string EncodeValue(short value)
        {
            return Math.Sign(value) switch
            {

...
{
    internal sealed class InAndOutToEdgeConnectionQueryExecutor(
        IGraphQueryService graphDataQueryService,
        IToEdgeConnectionQueryExecutor toEdgeConnectionQueryExecutor) : IGraphQueryNodeExecutionService<InAndOutToEdgeConnectionQuery>
    {
           ...
           CancellationToken cancellationToken)
        {
            return await toEdgeConnectionQueryExecutor.ExecuteAsync(
                ...
                GetCursorNodeInId,
                GetCursorNodeOutId,
                graphDataQueryService.GetInAndOutToEdgeConnectionAsync,
                cancellationToken);
        }
        ...
        private static string GetQueryNodeSourceTypeName(ToEdgeConnectionQuery query)
        {
            return query switch
            {
                InAndOutToEdgeConnectionQuery inOutQuery => inOutQuery.NodeInAndOutTypeName,

...
{
    internal sealed class InFromEdgeConnectionQueryExecutor(
        IFromEdgeConnectionQueryExecutor fromEdgeConnectionQueryExecutor) : IGraphQueryNodeExecutionService<InFromEdgeConnectionQuery>
    {
           ...
           CancellationToken cancellationToken)
        {
            return await fromEdgeConnectionQueryExecutor
                .ExecuteAsync(context, key, edge => [edge.InId], cancellationToken);
        }

...
{
    internal sealed class InToEdgeConnectionQueryExecutor(
        IGraphQueryService graphDataQueryService,
        IToEdgeConnectionQueryExecutor toEdgeConnectionQueryExecutor) : IGraphQueryNodeExecutionService<InToEdgeConnectionQuery>
    {
        ...
        private static string GetQueryNodeSourceTypeName(ToEdgeConnectionQuery query)
        {
            return query switch
            {
                InToEdgeConnectionQuery outQuery => outQuery.NodeInTypeName,

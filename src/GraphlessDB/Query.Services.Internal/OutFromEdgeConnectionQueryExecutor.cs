...
{
    internal sealed class OutFromEdgeConnectionQueryExecutor(
        IFromEdgeConnectionQueryExecutor fromEdgeConnectionQueryExecutor) : IGraphQueryNodeExecutionService<OutFromEdgeConnectionQuery>
    {
           ...
           CancellationToken cancellationToken)
        {
            return await fromEdgeConnectionQueryExecutor
                .ExecuteAsync(context, key, edge => [edge.OutId], cancellationToken);
        }

...
{
    internal sealed class OutToAllEdgeConnectionQueryExecutor(
        IGraphQueryService graphDataQueryService,
        IToEdgeConnectionQueryExecutor toEdgeConnectionQueryExecutor) : IGraphQueryNodeExecutionService<OutToAllEdgeConnectionQuery>
    {
        ...
        private static string GetQueryNodeSourceTypeName(ToEdgeConnectionQuery query)
        {
            return query switch
            {
                OutToAllEdgeConnectionQuery outQuery => outQuery.NodeOutTypeName,

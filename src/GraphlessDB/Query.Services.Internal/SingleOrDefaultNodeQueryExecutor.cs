...
{
    internal sealed class SingleOrDefaultNodeQueryExecutor(IGraphCursorSerializationService cursorSerializationService) : IGraphQueryNodeExecutionService<SingleOrDefaultNodeQuery>
    {
